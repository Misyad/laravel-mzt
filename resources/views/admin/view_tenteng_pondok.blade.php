...
<div class="mzt-page-header">
  <div><h1>Info Pesantren</h1><div class="description">Tentang &middot; Info Pesantren</div></div>
</div>
...
$(document).ready(function() {
  ...
  $('#form_info_pesantren').submit(function(e){
    ...
    $.ajax({url:"/edit-info-pesantren/simpan",method:"POST",data:data,processData:false,contentType:false,
