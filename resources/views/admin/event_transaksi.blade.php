...
<div class="mzt-page-header">
  <div><h1>Transaksi Event</h1><div class="description">Pilih event untuk melihat transaksi</div></div>
</div>
...
$(document).ready(function() {
  var table = $('#tabel_event').DataTable({
    ...
    columns:[{data:'judul_event'},{data:'lokasi'},{data:'slug'},{data:'tanggal'},{data:'harga'}],
    aoColumnDefs:[{targets:5,data:'id',"render":function(data,catatan,row){
      return '<a href="/tabel-event-transaksi/transaksi?id='+row.id+'"><i class="far fa-eye"></i></a>';
    }}],
